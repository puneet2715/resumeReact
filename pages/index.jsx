    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className="px-10 bg-white dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="flex justify-between py-8 mb-12 dark:text-white">
            <h1 className="text-xl font-burtons">developedbyPuneet</h1>
          ...
          <div className="p-10 py-10 text-center">
            ...
            <div className="flex justify-center gap-16 py-3 text-5xl text-gray-600 dark:text-gray-400 max-xs:gap-8">
              <a
            ...
            <div className="relative mx-auto mt-20 overflow-hidden rounded-full bg-gradient-to-b from-teal-500 w-80 h-80 max-xs:h-64 max-xs:w-64 md:h-96 md:w-96 max-xxs:m-0 max-xxs:p-0 max-xxs:mx-auto">
              <Image
